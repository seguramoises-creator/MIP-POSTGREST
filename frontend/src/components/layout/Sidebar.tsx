...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Mis Exámenes',          path: '/mis-examenes',  icon: <AssignmentTurnedIn />, roles: ['ADMIN', 'GERENTE_DISTRITO', 'GERENTE_MARCA', 'REPRESENTANTE_MEDICO'] },
  { label: 'Exámenes — Equipo',     path: '/examenes-equipo', icon: <Groups />,           roles: ['ADMIN', 'GERENTE_DISTRITO'] },
