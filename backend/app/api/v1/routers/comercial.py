...
def get_comercial(
    ...
    if pais_codigo:
        qv = qv.filter(Ventas.pais_codigo == pais_codigo)
    if ciclo_id:
...
def get_ventas(
    ...
    if pais_codigo: q = q.filter(Ventas.pais_codigo == pais_codigo)
...
def get_evoir(
    ...
    if pais_codigo: q = q.filter(EvoIR.pais_codigo == pais_codigo)
