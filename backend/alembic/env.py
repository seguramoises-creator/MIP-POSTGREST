...
from app.models import ia_conexion  # noqa: F401,E402  ← Security.DIM_IAConexion (Conexiones de IA)
from app.models import formacion  # noqa: F401,E402  ← esquema formacion (Ampliación del Módulo de Formación)
